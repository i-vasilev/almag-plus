...
public abstract class DefaultDataInserter {
    ...
    static void InsertFirstPlan(SQLiteDatabase db) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(DBHelper.KEY_DESCRIPTION_PLANS, "План лечения пациентов от 15 лет");
    ...
    static void InsertThirdPlan(SQLiteDatabase db) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(DBHelper.KEY_DESCRIPTION_PLANS, "План лечения пациентов от 1 года до 3 лет");
        contentValues.put(DBHelper.KEY_VERSION_PLANS, 0);
    ...
    static void InsertFourthPlan(SQLiteDatabase db) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(DBHelper.KEY_DESCRIPTION_PLANS, "План лечения пациентов от 3 до 7 лет");
        contentValues.put(DBHelper.KEY_VERSION_PLANS, 0);
    ...
    static void InsertFivesPlan(SQLiteDatabase db) {
        ContentValues contentValues = new ContentValues();
        contentValues.put(DBHelper.KEY_DESCRIPTION_PLANS, "План лечения пациентов от 7 до 15 лет");
        contentValues.put(DBHelper.KEY_VERSION_PLANS, 0);
        contentValues.put(DBHelper.KEY_ID_PLAN, 4);
        db.insertOrThrow(DBHelper.TABLE_PLANS, null, contentValues);
        for (int i = 1; i <= 4; i++) {
            contentValues.clear();
            contentValues.put(DBHelper.KEY_DAY_DETAILED_PLANS, i);

...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, 2);
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, 3);
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, 4);
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, 5);
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, 6);
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, 7);
        ...
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        DefaultDataInserter.InsertFirstPlan(db, "От 50 лет", 0);
        DefaultDataInserter.InsertFirstPlan(db, "От 40 до 50 лет", 1);
        DefaultDataInserter.InsertFirstPlan(db, "От 25 до 40 лет", 2);
        DefaultDataInserter.InsertFirstPlan(db, "От 15 до 25 лет", 3);

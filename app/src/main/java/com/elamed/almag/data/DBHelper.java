...
public class DBHelper extends SQLiteOpenHelper {
    ...
    public static final String KEY_NAME_ADDITIONAL_ARTICLES = "name";
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("create table " + TABLE_ADDITIONAL_ARTICLES + "("
                ...
                + KEY_NAME_ADDITIONAL_ARTICLES + " text, "
                + KEY_VERSION_ADDITIONAL_ARTICLES + " integer, "
                + KEY_PREF_TYPE_ADDITIONAL_ARTICLE + " text)");
        ...
        valuesDiseases.put(KEY_IMAGE_DISEASE, "1.gif");
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "6.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "8.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "19.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "17.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "15.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "12.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "13.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "22.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        ...
        valuesDiseases.put(KEY_ID_DISEASE, id++);
        valuesDiseases.put(KEY_VERSION_DISEASE, 0);
        valuesDiseases.put(KEY_IMAGE_DISEASE, "24.gif");
        db.insertOrThrow(TABLE_DISEASES, null, valuesDiseases);
        valuesDiseases.clear();
        id = 0;
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/almag/1.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_ALMAG);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Общее описание");
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/almag/2.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_ALMAG);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Яркие преимущества");
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/almag/3.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_ALMAG);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Научные исследования");
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/almag/4.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Причины выбрать Алмаг+");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_ALMAG);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/1.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Действие МП на эндокринную систему");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/2.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Биофизические механизмы действия и клинические эффекты магнитотерапии");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/3.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Действие МП на нервную систему");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/4.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Действие МП на кровь и иммунную систему");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/5.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Действие МП на обмен веществ");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/6.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Действие МП на костно-мышечную систему");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        valuesDiseases.put(KEY_ID_ADDITIONAL_ARTICLES, id++);
        valuesDiseases.put(KEY_ARTICLE_ADDITIONAL_ARTICLES, getStringFile("articles/magnitoterapy/7.html"));
        valuesDiseases.put(KEY_VERSION_ADDITIONAL_ARTICLES, 1);
        valuesDiseases.put(KEY_NAME_ADDITIONAL_ARTICLES, "Действие МП на сердечно-сосудистую систему");
        valuesDiseases.put(KEY_PREF_TYPE_ADDITIONAL_ARTICLE, PREF_MAGNETOTHERAPY);
        db.insertOrThrow(TABLE_ADDITIONAL_ARTICLES, null, valuesDiseases);
        valuesDiseases.clear();
        DefaultDataInserter.InsertFirstPlan(db, "От 50 лет", 7);
        DefaultDataInserter.InsertFirstPlan(db, "От 40 до 50 лет", 6);
        DefaultDataInserter.InsertFirstPlan(db, "От 25 до 40 лет", 5);
        DefaultDataInserter.InsertFirstPlan(db, "От 15 до 25 лет", 4);
